...
def get_env_parameter() -> dict:
    ...
    download_category = os.environ.get('DOWNLOAD_CATEGORY') or "films"
    ...
    rootpath = "/movies/" + download_category
    remotepath = "/downloads/"
    localpath = "/movies/downloads/"
...
def reconcile(desired: dict, current: dict):
    ...
    # Set custom formats and profiles parameter
    db.set_custom_format()
    db.set_custom_profile()
...
def restart():
    ...
    os.popen('s6-svc -r /var/run/s6-rc/servicedirs/svc-radarr/')
